...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cur = resolver.query(WeatherContract.LocationEntry.CONTENT_URI,
        ...
        if (cur.moveToFirst()) {
            ...
            Uri inserted = resolver.insert(WeatherContract.LocationEntry.CONTENT_URI, locationValues);
    ...
    private Void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                inserted = mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cVVector.toArray(array));
            }
